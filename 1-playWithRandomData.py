...
env = gym.make('CartPole-v1') # load this particular game. Other games are available. 
env.reset()
goal_steps = 200  # Timesteps a game runs
score_requirement = 10  # Timesteps a game needs to be accepted in to training set. 50 is good
